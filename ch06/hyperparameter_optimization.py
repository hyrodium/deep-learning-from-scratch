...
from DLFS.common.multi_layer_net import MultiLayerNet
from DLFS.common.util import shuffle_dataset
from DLFS.common.trainer import Trainer
...
def __train(lr, weight_decay, epocs=50):
    ...
    trainer = \
        Trainer(network, x_train, t_train, x_val, t_val,
                epochs=epocs,
                mini_batch_size=100,
                optimizer='sgd',
